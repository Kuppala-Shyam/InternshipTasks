...
public class BookControllerTest {
	...
	public void testDeleteBookByBookTitle_ExistingBook() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.delete("/deleteBookByBookTitle/{bookTitle}", book.getBookTitle()))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.content().string("Book delete successfully by using book tilte")); // Verify
																													// response
																													// message																											// content
	}
    ...
    public void testDeleteBookByBookId_ExistingBook() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/deleteBookByBookId/{bookId}", book.getBookId()))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().string("Book delete successfully by using book id")); // Verify response message content

        // Optional: Verify that the service method is called (consider mocking behavior based on your implementation)
