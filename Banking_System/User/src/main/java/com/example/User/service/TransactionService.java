...
public class TransactionService {
	 ...
	 * @return A TransactionRequest object containing details of the transaction.
	 * @throws AccountNotFoundException    if either sender or receiver account is
	 *                                     not found.
	 * @throws InsufficientAmountException if the sender account has insufficient
	 *                                     balance.
	 * @throws RuntimeException            if any unexpected error occurs during the
		...
		try {
			if (senderAccount == null || receiverAccount == null) {
				throw new AccountNotFoundException(
						"Please check the account numbers you entered. They are not correct. Re-enter the correct credentials.");
			}
			...
			// Catching any other unexpected exceptions and wrapping them in a
			// RuntimeException
